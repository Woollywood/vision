...
export let formValidate = {
	...
	validateInput(formRequiredItem) {
		...
		if (formRequiredItem.dataset.required === 'email') {
			...
			if (!formRequiredItem.value.trim()) {
				this.addError(formRequiredItem);
				error++;
			} else if (formRequiredItem.classList.contains('tel') && formRequiredItem.value.length !== 16) {
				this.addError(formRequiredItem);
				error++;
			} else {
				this.removeError(formRequiredItem);
	...
	addError(formRequiredItem) {
		...
		formRequiredItem.closest('form').querySelector('button').setAttribute('disabled', '');
	...
	removeError(formRequiredItem) {
		...
		formRequiredItem.closest('form').querySelector('button').removeAttribute('disabled');
